...
The `public contributions` and `private contributions` by users in Finland on `2026/4/21 9:22 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
