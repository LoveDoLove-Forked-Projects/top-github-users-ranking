...
The `public contributions` and `private contributions` by users in Georgia on `2026/4/22 12:09 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/yittens">
				<img src="https://avatars.githubusercontent.com/u/207972880?s=72&u=c0801a152de4bb6693942deb4db893c334d12fc1&v=4" width="24" alt="Avatar of yittens"> yittens
			</a><br/>
			yitten
		</td>
		<td>No Company</td>
