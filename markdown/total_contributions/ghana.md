...
The `public contributions` and `private contributions` by users in Ghana on `2026/4/22 6:27 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
