...
The `public contributions` and `private contributions` by users in Benin on `2026/4/19 5:11 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/lionel-hue">
				<img src="https://avatars.githubusercontent.com/u/71542962?s=72&u=4aa964f4cab00ec8c529c232f42b9184ba2276f9&v=4" width="24" alt="Avatar of lionel-hue"> lionel-hue
			</a><br/>
			Lionel SISSO
		</td>
		<td>No Company</td>
