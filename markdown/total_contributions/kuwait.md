...
The `public contributions` and `private contributions` by users in Kuwait on `2026/4/13 6:37 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/halfwhey">halfwhey</a></td>
		<td>Kuwait</td>
		<td>193</td>
		<td>193</td>
	</tr>
