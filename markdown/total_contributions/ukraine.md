...
The `public contributions` and `private contributions` by users in Ukraine on `2026/4/18 6:05 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
