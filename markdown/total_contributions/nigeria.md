...
The `public contributions` and `private contributions` by users in Nigeria on `2026/4/25 10:36 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
