...
The `public contributions` and `private contributions` by users in Bulgaria on `2026/4/19 11:21 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
