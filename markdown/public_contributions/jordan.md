...
The `public contributions` by users in Jordan on `2026/4/12 11:10 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
