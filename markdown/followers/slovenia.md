...
The `number of followers` of users in Slovenia on `2026/4/26 6:14 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
