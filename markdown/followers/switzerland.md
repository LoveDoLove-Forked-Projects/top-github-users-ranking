...
The `number of followers` of users in Switzerland on `2026/4/17 3:48 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
