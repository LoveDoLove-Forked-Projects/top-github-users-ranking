...
The `number of followers` of users in Montenegro on `2026/4/24 8:15 PM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.
...
<table>
	...
	<tr>
		<td>922</td>
		<td>
			<a href="https://github.com/tinkyywiinkyyy">
				<img src="https://avatars.githubusercontent.com/u/193957433?s=72&v=4" width="24" alt="Avatar of tinkyywiinkyyy"> tinkyywiinkyyy
			</a><br/>
			Kristina Keković
		</td>
		<td>No Company</td>
