...
The `number of followers` of users in Botswana on `2026/4/19 9:08 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
