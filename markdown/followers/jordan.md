...
The `number of followers` of users in Jordan on `2026/4/12 11:10 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `971 users`  in Jordan. You need at least `9 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fiercew1ngs">
				<img src="https://avatars.githubusercontent.com/u/214259460?s=72&u=8191d751aa69d644f2e6dbc6fb5df1252c9e2f81&v=4" width="24" alt="Avatar of fiercew1ngs"> fiercew1ngs
			</a><br/>
			♯┆𝐊𝐞𝐢𝐠𝐨 ⸝⸝ 𝑳𝒖 ♡
		</td>
		<td>F ; ⤷ ゛@usua1katze<br/>,<br/>@eternityspentwaitin<br/>,<br/>@decyingf0ol<br/>,<br/>@shlofolna<br/>,<br/>@jax0live<br/>,<br/>@cannibalsttic<br/>,<br/>@tboe-chudo<br/>,<br/>@fallingempire<br/>ˎˊ˗<br/></td>
		<td>No Twitter Username</td>
